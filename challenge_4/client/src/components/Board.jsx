class Board extends React.Component {
  constructor(props) {
    super(props);
    this.state = { counter: 0, color: "yellowSpace", win: '', red: [], yellow: [] };
    this.handleClick = this.handleClick.bind(this);
    this.winTest = this.winTest.bind(this);
  }
  ...
  winTest(allPieces) {
    ...
    for (var i = 0; i < allPieces.length; i++) {
      if (allPieces.indexOf(allPieces[i] + 9) !== -1) {
        ...
        console.log('wincount', diagDownWin)
      } else {
        diagDownWin = 1;
      }
      if(diagDownWin === 4) {
  ...
  render () {
    return (
      <div>
        ...
        <div id="board">
          <div id="col1" onClick={this.handleClick}>
